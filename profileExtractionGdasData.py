...
end = datetime.datetime(2024, 6, 24, 23, 59)
#secod period
#dt = datetime.datetime(2024, 9, 16)
#end = datetime.datetime(2024, 10, 31, 23, 59)
...
df.to_csv("Perfiles_MayJun2024.csv", index=False)
